...
- **codex** - Bootstrap shim that installs OpenAI's [Codex CLI](https://github.com/openai/codex) on first run, so `codex update` and other native features work as if installed via the official installer
