#!/bin/bash
# Build trac_ik metapackage from the trac_ik monorepo
set -eo pipefail
...
# The monorepo has multiple packages; build only trac_ik metapackage
WORK_DIR=$SRC_DIR/$PKG_NAME/src/work/trac_ik
