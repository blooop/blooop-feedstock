#!/bin/bash
# Build trac_ik_kinematics_plugin from the trac_ik monorepo
set -eo pipefail
...
# The monorepo has multiple packages; build only trac_ik_kinematics_plugin
WORK_DIR=$SRC_DIR/$PKG_NAME/src/work/trac_ik_kinematics_plugin
