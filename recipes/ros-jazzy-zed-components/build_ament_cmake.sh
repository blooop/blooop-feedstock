#!/bin/bash
# Hybrid build: assumes ZED SDK installed at /usr/local/zed and CUDA at /usr/local/cuda
set -eo pipefail
...
# ZED SDK and CUDA paths (from Docker environment)
export ZED_DIR=/usr/local/zed
export CUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda

WORK_DIR=$SRC_DIR/$PKG_NAME/src/work/zed_components
