#!/bin/bash
# Build moveit_ros_control_interface from the moveit2 monorepo
set -eo pipefail
...
# The moveit2 monorepo has many packages; build only moveit_ros_control_interface
WORK_DIR=$SRC_DIR/$PKG_NAME/src/work/moveit_plugins/moveit_ros_control_interface
